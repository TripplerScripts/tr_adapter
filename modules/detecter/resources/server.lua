...
exports.tr_lib:print({type = 'info', message = ('[Resource Detector] Stored %s resource names'):format(#ServerResourcesNames), path = debug.getinfo(1, "Sl").short_src, line = debug.getinfo(1, "Sl").currentline})
